...
import { ProjectCreateModal, type ProjectDefaults } from "@/components/projects/project-create-modal";
...
type Create =
  ...
  | { kind: "project"; defaults?: ProjectDefaults }
...
export function UIProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <UICtx.Provider value={{ create: setC, palette, setPalette }}>
      ...
      {c?.kind === "project" && <ProjectCreateModal defaults={c.defaults} onClose={close} />}
